...
/** Segundo método de teste utilizando um arquivo CSV, feito para treinar no curso de Selenium da Alura
 * com o professor Julio de Lima.
 * Essa classe não está estruturada no modelo PageObject
 * 
 * @date 07/07/2020
 * @author jay
 */
...
public class testAdicionarInformacaoAdicionalDoUsuario {
	...
	@Rule	//	Para pegar o nome do método de teste
